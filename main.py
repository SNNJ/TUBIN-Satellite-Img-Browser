...
# from firstui import window
# from uiCmp import Ui_MainWindow
#
#
#
#
# #
# py= open("simpletest.py",'w')
# print('2_2')
# try:
#     compileUi("TuFinal.ui",py)
# finally:
#     py.close()
#
# # def window():
...
# #         self.setWindowTitle("This is what I wana see")
# #         self.initUI()
# #     def initUI(self):
...
# #     def clicked(self):
# #         self.label.setText("from inside the class")
# #         self.label.adjustSize()
# #
# #
# #
# # def clicked():
# #     print("this is the first click")
# # def window():
# #     app = QApplication(sys.argv)
# #     win = Mywindow()
# #     #     label = QtWidgets.QLabel(win)
